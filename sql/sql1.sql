...
select "Name", "Milliseconds" from "Track" where "Milliseconds" > 300.000;
...
select "FirstName" as "First_Name", "LastName" as "Last_Name", "Title" from "Employee" where "Title" = 'Sales Support Agent'; 
...
select "FirstName" as "First_Name", "LastName" as "Last_Name", "EmployeeId" from "Employee" where "EmployeeId" = 1; 
...
select "Name" as "Track_Name", ("Milliseconds" / 60000.0) as "Duration_Minuts" from "Track" where ("Milliseconds" / 60000.0) > 5;
...
select "Name", "Milliseconds" from "Track" where "UnitPrice" > 1.00 and "Milliseconds" < 300000;
...
select "FirstName", "LastName" from "Customer" where "Country" = 'USA' and "CustomerId" >= 5;
...
select "InvoiceId", "Total" from "Invoice" where "Total" > 10.00 and "CustomerId" > 50;
